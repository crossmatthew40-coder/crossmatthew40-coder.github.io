...
window.HSM_APP = {
  version: '1.1.5-opening-brand-login',
...
(function applyHighStyleBranding(){
  function loadTheme(){if(!document.querySelector('link[data-hsm-pro-theme]')){const link=document.createElement('link');link.rel='stylesheet';link.href='./capture-one-theme.css?v=20260907-11';link.dataset.hsmProTheme='true';document.head.appendChild(link)}if(!document.querySelector('link[data-hsm-purple-theme]')){const purple=document.createElement('link');purple.rel='stylesheet';purple.href='./high-style-purple-theme.css?v=20260907-11';purple.dataset.hsmPurpleTheme='true';document.head.appendChild(purple)}}
  function ensureTwoSecondOpening(){const style=document.createElement('style');style.textContent=`
    ...
    .hsm-opening-brandcopy span{margin-top:8px;font-size:clamp(10px,1.2vw,14px);letter-spacing:.14em;text-transform:uppercase;color:#9F91E8;font-weight:750;white-space:nowrap}
  ...
  function loadProductUpgrades(){loadScript('./product-upgrades.js?v=20260907-11','hsm-upgrades');loadScript('./capture-delivery-tools.js?v=20260907-11','hsm-capture-delivery');loadScript('./integration-notice.js?v=20260907-11','hsm-integration-notice')}
