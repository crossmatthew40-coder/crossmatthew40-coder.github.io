...
async function renderClientReviewDetail(reviewId){
 ...
 C.innerHTML=pageHead((r.recipient_name||r.recipient_email)+" — Client Selection",esc(r.hsm_projects.name),'<button class="btn secondary" id="backReviews">← Client Reviews</button>')+
